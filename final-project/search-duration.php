    ...
    <body>
    	...
    	<div class="table-control">
    		<form class="col-md-5" method="post" action="search-duration.php">
    			...
    			<!-- The Default value is being set to 190, or 3:00 -->
    				<option value="&lt; 181">Less Than 3:00</option>
    				<option value="&gt; 180 AND Songs.Duration &lt; 271">3:00 - 4:30</option>
    				<option value="&gt; 270">Longer Than 5:00</option>
    			</select>
